...
namespace LXP.Core.Services
{
    public class LearnerProgressService : ILearnerProgressService
    {
        ...
        public async Task Progress(LearnerProgressViewModel learnerProgress)
        {
            ...
            int Coursehours = (int)totalCoursetime % 24;
            int CourseMinutes = (int)((totalCoursetime - Coursehours) * 60) % 60;
            ...
            Console.WriteLine(CourseDuration);
            double totalCourseWatchtime = await CourseWatchTime(learnerProgress.CourseId, learnerProgress.LearnerId);
            int CourseWatchhours = (int)totalCourseWatchtime % 24;
            int CourseWatchMinutes = (int)((totalCourseWatchtime - CourseWatchhours) * 60) % 60;
